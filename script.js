...
function imgURL(item) {
  ...
  if(item==1){
    ...
    image_slide.style.backgroundImage = "url('https://vidrio-aluminio.github.io/domo/images/1.jpg')"
  }
  ...
  if(item==2){
    ...
    image_slide.style.backgroundImage = "url('https://vidrio-aluminio.github.io/domo/images/2.jpg')"
  }
  ...
  if(item==3){
    ...
    image_slide.style.backgroundImage = "url('https://vidrio-aluminio.github.io/domo/images/3.jpg')"
  }
  ...
  if(item==4){
    ...
    image_slide.style.backgroundImage = "url('https://vidrio-aluminio.github.io/domo/images/4.jpg')"
  }
  ...
  if(item==5){
    ...
    image_slide.style.backgroundImage = "url('https://vidrio-aluminio.github.io/domo/images/5.jpg')"
  }
  ...
  if(item==6){
    ...
    image_slide.style.backgroundImage = "url('https://vidrio-aluminio.github.io/domo/images/6.jpg')"
  }
  ...
  if(item==7){
    ...
    image_slide.style.backgroundImage = "url('https://vidrio-aluminio.github.io/domo/images/7.jpg')"
  }
}
